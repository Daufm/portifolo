...
function Hero() {
    ...
    return (
        <div className="relative flex flex-row gap-14 items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 dark:from-gray-900 dark:to-blue-900 p-8 overflow-hidden">
            ...
            {/* Info Section */}
            <div className={`flex flex-col items-center justify-center z-10 transition-all duration-900 ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}> 
                <TextPressure text="Hi, I’m Fuad Mohammed" textColor='text-gray-300' />
                <p className="text-center text-gray-400 dark:text-gray-300 mb-4 text-lg font-medium animate-fade-in">
